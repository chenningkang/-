	...
	$(function(){
	var	url ="http://47.91.167.130:8032/appInterface/lottery/findLatelyLotteryResult2.do?type=syxw";
      $.ajax({
        data:{"type":"syxw"},//参数
       // dataType: 'jsonp',
	    type:"GET",
 ...
 $(function(){
	var	url ="http://47.91.167.130:8032/appInterface/lottery/findLotteryResult2.do?type=syxw";
      $.ajax({
        data:{"type":"syxw"},//参数
       // dataType: 'jsonp',
	    type:"GET",
        ...
        success: function(data) {
			...
			for(i=0;i<10;i++){
				...
				$("#li1").append("<li id='li1'><a href='kaijiang008.html'>"
