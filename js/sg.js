...
$.tzDialog.methods = {
	...
	params:function($dialog,opts){
		...
		$dialog.find(".tzdialog_message").css({"textAlign":"center","lineHeight":opts.height-160+"px"}).height(opts.height-145);
		//弹出层居中
	...
	template : function(opts){
		var $dialog = $("<div class='tzui-dialog "+tz_animateIn(18)+"'>"+
